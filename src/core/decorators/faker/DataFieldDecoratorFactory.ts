import { ModelSchema } from './types/faker.d';
 ...
 * 数据字段装饰器工厂
 */
export class DataFieldDecoratorFactory extends DecoratorFactory {
  /**
   * 装饰器信息
   */
   ...
   * 预处理配置
   */
  protected preHandleConfig(config: DataFieldType) {}
  /**
   * 预检查配置
   */
  protected preCheckConfig(config: DataFieldType): void {}
