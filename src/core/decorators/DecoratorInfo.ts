...
import { DecoratedClassOrProto, DecorationInfo, DecoratorType } from './decorator';
...
export class DecoratorInfo implements DecorationInfo {
  ...
  constructor(decoratorInfo?: DecorationInfo) {
    ...
    const { name = 'unknown', type = 'unknown', configs = [], conflictList = [], dependsOn = [] } = decoratorInfo;
    this.name = name;
    this.type = type;
